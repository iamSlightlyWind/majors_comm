<%@page contentType="text/html" pageEncoding="UTF-8" %>
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <body>
      ...
      <div>
        <link href="/Manage/manage.css" rel="stylesheet" />

        <div class="manage-container10">
          <div class="manage-container11">
            <navloggedin-wrapper class="navloggedin-wrapper">
              ...
              <div class="navloggedin-navloggedin">
                <div class="navloggedin-logo">
                  <span>
                    <fragment class="manage-fragment1">
                      <span class="manage-text10">Major's</span>
                    </fragment>
                  </span>
                  <span>
                    <fragment class="manage-fragment2">
                      <span class="manage-text11">
                        <span>Comm</span>
                        <br />
                      </span>
                    </fragment>
            ...
            <div class="manage-container12">
              <div class="manage-friend-container">
                <div class="manage-container13">
                  <div class="manage-container14">
                    <span class="manage-text14">
                      <span>Activated Users</span>
                      <br />
                    </span>
                  </div>
                  <form class="manage-search-form1" action="/moderate" method="post">
                    <input type="text" placeholder="Search in activated" name="activatedSearch"
                      value="${activatedSearch}" class="manage-textinput1 input" />
                    <button type="submit" name="action" value="searchActivated" style="visibility: hidden;"></button>
                  </form>
                  <c:forEach var="user" items="${activated}">
                    <form class="manage-found-form">
                      <input type="hidden" name="theirID" value="${user.id}" />
                      <div class="manage-container15">
                        <img alt="image" src="/upload/profile/${user.id}.png" class="manage-image1" />
                        <span class="manage-text17">${user.fullName}</span>
                        <div class="manage-container16">
                          <button type="submit" name="action" value="setFriend" class="manage-button1 button">
                            Set Friend
                          </button>
                          <button type="submit" name="action" value="deactivate" class="manage-button2 button">
                            Disable
                          </button>
                        </div>
                      </div>
              ...
              <div class="manage-request-container">
                <div class="manage-container17">
                  <div class="manage-container18">
                    <span class="manage-text18">
                      <span>Disabled Users</span>
                      <br />
                    </span>
                  </div>
                  <form class="manage-search-form2" action="/moderate" method="post">
                    <input type="text" placeholder="Search in deactivated" name="activatedSearch"
                      value="${activatedSearch}" class="manage-textinput2 input" />
                    <button type="submit" name="action" value="searchDeactivated" style="visibility: hidden;"></button>
                  </form>
                  <c:forEach var="user" items="${deactivated}">
                    <form class="manage-requested-form">
                      <input type="hidden" name="theirID" value="${user.id}" />
                      <div class="manage-container19">
                        <img alt="image" src="/upload/profile/${user.id}.png" class="manage-image2" />
                        <span class="manage-text21">${user.fullName}</span>
                        <div class="manage-container20">
                          <button type="submit" name="action" value="activate" class="manage-button3 button">
                            Enable
                          </button>
                        </div>
                      </div>
