<%@page contentType="text/html" pageEncoding="UTF-8" %>
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <head>
      <title>Login - Major's Comm</title>
      <meta property="og:title" content="Login - Major's Comm" />
    ...
    <body>
      ...
      <div>
        ...
        <div class="authentication-login-container">
          <navguest-wrapper>
            <div class="navguest-container navguest-root-class-name">
              <header data-thq="thq-navbar" class="navguest-navbar-interactive">
                ...
                <div data-thq="thq-navbar-nav" class="navguest-desktop-menu">
                  <nav class="navguest-links">
                    <span>
                      <fragment class="authentication-login-fragment">
                        <span class="authentication-login-text">Features</span>
                      </fragment>
                    </span>
                    <span>
                      <fragment class="authentication-login-fragment01">
                        <span class="authentication-login-text01">Contact</span>
                      </fragment>
                    </span>
                    <span>
                ...
                <div data-thq="thq-mobile-menu" class="navguest-mobile-menu">
                  <div class="navguest-nav">
                    ...
                    <nav class="navguest-links1">
                      <span>
                        <fragment class="authentication-login-fragment02">
                          <span class="authentication-login-text02">About</span>
                        </fragment>
                      </span>
                      <span>
                        <fragment class="authentication-login-fragment03">
                          <span class="authentication-login-text03">
                            Features
                          </span>
                        </fragment>
                      </span>
                      <span class="authentication-login-text08">
                        <fragment class="authentication-login-fragment04">
                          <span class="authentication-login-text04">Pricing</span>
                        </fragment>
                      </span>
                      <span class="authentication-login-text09">
                        <fragment class="authentication-login-fragment05">
                          <span class="authentication-login-text05">Team</span>
                        </fragment>
                      </span>
                      <span class="authentication-login-text10">
                        <fragment class="authentication-login-fragment07">
                          <span class="authentication-login-text07">Blog</span>
                        </fragment>
                      </span>
                    </nav>
                    <div class="navguest-buttons">
                      <button class="navguest-login button">
                        <span class="authentication-login-text11">
                          <fragment class="authentication-login-fragment06">
                            <span class="authentication-login-text06">Login</span>
                          </fragment>
                        </span>
                      </button>
                      <button class="button">
                        <span class="authentication-login-text12">
          ...
          <div class="authentication-login-container1">
            <form class="authentication-login-form" action="/auth" method="post">
              <div class="authentication-login-container2">
                ...
                <span class="authentication-login-text14">TheMajorOnes</span>
              </div>
              <div class="authentication-login-input">
                <input type="text" name="login" required="true" autofocus="true" placeholder="Email address or Username"
              ...
              <a class="authentication-login-button1 button" href="/auth?action=recovery">
