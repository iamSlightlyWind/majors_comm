<%@page contentType="text/html" pageEncoding="UTF-8" %>
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <head>
      <title>AuthenticationRegister - Fearless Primary Shrew</title>
      <meta property="og:title" content="AuthenticationRegister - Fearless Primary Shrew" />
    ...
    <body>
      ...
      <div>
        <link href="./authentication-register.css" rel="stylesheet" />

        <div class="authentication-register-container">
          <navguest-wrapper>
            <div class="navguest-container navguest-root-class-name1">
              <header data-thq="thq-navbar" class="navguest-navbar-interactive">
                ...
                <div data-thq="thq-navbar-nav" class="navguest-desktop-menu">
                  <nav class="navguest-links">
                    <span>
                      <fragment class="authentication-register-fragment">
                        <span class="authentication-register-text">Features</span>
                      </fragment>
                    </span>
                    <span>
                      <fragment class="authentication-register-fragment01">
                        <span class="authentication-register-text01">
                          Contact
                        </span>
                      </fragment>
                    </span>
                ...
                <div data-thq="thq-mobile-menu" class="navguest-mobile-menu">
                  <div class="navguest-nav">
                    ...
                    <nav class="navguest-links1">
                      <span>
                        <fragment class="authentication-register-fragment02">
                          <span class="authentication-register-text02">
                            About
                          </span>
                        </fragment>
                      </span>
                      <span>
                        <fragment class="authentication-register-fragment03">
                          <span class="authentication-register-text03">
                            Features
                          </span>
                        </fragment>
                      </span>
                      <span class="authentication-register-text08">
                        <fragment class="authentication-register-fragment04">
                          <span class="authentication-register-text04">
                            Pricing
                          </span>
                        </fragment>
                      </span>
                      <span class="authentication-register-text09">
                        <fragment class="authentication-register-fragment05">
                          <span class="authentication-register-text05">Team</span>
                        </fragment>
                      </span>
                      <span class="authentication-register-text10">
                        <fragment class="authentication-register-fragment07">
                          <span class="authentication-register-text07">Blog</span>
                        </fragment>
                      </span>
                    </nav>
                    <div class="navguest-buttons">
                      <button class="navguest-login button">
                        <span class="authentication-register-text11">
                          <fragment class="authentication-register-fragment06">
                            <span class="authentication-register-text06">
                              Login
                            </span>
                          </fragment>
                        </span>
                      ...
                      <button class="button">
                        <span class="authentication-register-text12">
                          <fragment class="authentication-register-fragment12">
                            <span>Register</span>
                          </fragment>
                        </span>
                      </button>
          ...
          <div class="authentication-register-container1">
            <form class="authentication-register-form">
              <div class="authentication-register-container2">
                ...
                <span class="authentication-register-text14">TheMajorOnes</span>
              </div>
              <div class="authentication-register-input">
                <input type="text" name="email" required="true" autofocus="true" placeholder="Email address"
              ...
              <button type="submit" class="authentication-register-button2 button">
                ...
                <svg viewBox="0 0 860.0137142857142 1024" class="authentication-register-icon">
                  <path
